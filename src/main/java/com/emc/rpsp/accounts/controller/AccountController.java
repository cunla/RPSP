...
public class AccountController {
	...
	public ResponseEntity<Account> createAccount(@RequestBody Account account) {
		...
		httpHeaders.add(HttpHeaders.LOCATION, "accounts/" + createdAccount.getId());
...
/*	@PreAuthorize("hasAuthority('ADMIN')")
	@RequestMapping(value = "/accounts", params = { "packageId" }, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	public ResponseEntity<List<Account>> findPackageAccounts(
		...
		List<Account> accounts = packageDef.getAccounts();
		return new ResponseEntity<>(accounts, HttpStatus.OK);
	}*/
