...
public class AccountVmsStructureServiceImpl implements
	...
	private AccountVmsStructure getMockupData(){
		...
		//production cluster
		ClusterDefinition clusterDefinition1 = new ClusterDefinition("1", "London");
		...
		ClusterDefinition clusterDefinition3 = new ClusterDefinition("3", "Paris");
		...
		//production cluster
		ClusterDefinition clusterDefinition4 = new ClusterDefinition("4", "Tel Aviv");
		...
		ClusterDefinition clusterDefinition5 = new ClusterDefinition("5", "Jerusalem");;
