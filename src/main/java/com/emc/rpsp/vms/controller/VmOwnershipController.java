...
public class VmOwnershipController {
	...
	@ResponseBody
	public ResponseEntity<List<VmOwnership>> findAccountVms(@RequestParam("accountId") Long accountId) {
	...
	@PreAuthorize("hasAuthority('ADMIN')")
	@RequestMapping(value = "/vmownership", params = {"accountId"}, method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<VmOwnership> createVm(@RequestBody VmOwnership vmOwnership, @RequestParam("accountId") Long accountId) {
