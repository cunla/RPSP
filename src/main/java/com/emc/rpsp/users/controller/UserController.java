...
public class UserController {
	...
	/*
	 * @PreAuthorize("hasAuthority('ADMIN')") @RequestMapping(value = "/users",
	 * params = { "accountId" }, method = RequestMethod.GET, produces =
	 * MediaType.APPLICATION_JSON_VALUE)
	 * 
	 * @ResponseBody public ResponseEntity<List<User>>
	 * findAccountUsers(@RequestParam("accountId") Long accountId) { Account
	 * account = accountService.findById(accountId); if (account == null) {
	 * return new ResponseEntity<>(HttpStatus.BAD_REQUEST); } List<User> users =
	 * account.getUsers(); return new ResponseEntity<>(users, HttpStatus.OK); }
	 */
