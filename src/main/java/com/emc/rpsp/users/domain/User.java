...
public class User extends AbstractAuditingEntity implements Serializable {
    ...
    @NotNull @Size(min = 0, max = 50) @Column(length = 50) private String login;

    @JsonIgnore @Size(min = 0, max = 100) @Column(length = 100) private String password;

    @Size(min = 0, max = 50) @Column(name = "first_name", length = 50) private String firstName;

    @Size(min = 0, max = 50) @Column(name = "last_name", length = 50) private String lastName;
    ...
    //@JsonIgnore
    @ManyToOne(fetch = FetchType.EAGER) private Account account;
