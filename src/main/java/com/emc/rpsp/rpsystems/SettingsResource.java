...
public class SettingsResource {
	 ...
	 * log.debug("Testing systemSettings with id {}", id); SystemSettings
	 * systemSettings = new SystemSettings(); systemSettings.setIsDrttc(true);
	 * systemSettings.setIsMultiTenanctEnabled(false);
	 * systemSettings.setName("Test system");
	 * systemSettings.setSystemIp("10.64.125.131");
	 * systemSettings.setUser("admin"); systemSettings.setPassword("admin");
	 * return new ResponseEntity<>(systemSettings, HttpStatus.OK); }
	 */
