...
public class DataLoaderServiceImpl implements DataLoaderService{
	...
	public List<SystemSettings> populateInternalData(List<Map<String, Object>> fullSettings) {
		...
		for(Map<String, Object> currSettings : fullSettings){
			...
			//accounts data
			List<Map<String, Object>> accounts = (List<Map<String, Object>>)currSettings.get("accounts");
			for(Map<String, Object> currAccount : accounts){
				...
				//users data
				List<Map<String, Object>> users = (List<Map<String, Object>>)currAccount.get("users");
