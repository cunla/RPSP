...
app.controller('groupSetRecoverController', ['$scope', '$http', '$modal', '$modalInstance','vmStructureService', function ($scope, $http, $modal, $modalInstance, vmStructureService) {	
	...
	$scope.restoreProduction = function(){
		$scope.showError = false;
    	vmStructureService.groupSetRecoverProduction($scope.selectedCluster)
