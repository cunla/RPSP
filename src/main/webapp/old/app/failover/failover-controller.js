...
app.controller('failoverController', ['$scope', '$http', '$modal', '$modalInstance', '$window','vmStructureService', function ($scope, $http, $modal, $modalInstance, $window, vmStructureService) {	
	...
	$scope.activateFailover = function(){
		$scope.showError = false;
    	vmStructureService.activateFailover($scope.selectedCopy)
