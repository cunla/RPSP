...
app.controller('groupSetFailoverController', ['$scope', '$http', '$modal', '$modalInstance','vmStructureService', function ($scope, $http, $modal, $modalInstance, vmStructureService) {	
	...
	$scope.activateFailover = function(){
		$scope.showError = false;
    	vmStructureService.activateGroupSetFailover($scope.selectedCluster)
